...
open class Chassis(names: Array<String>, enable: Boolean) : Structure {
	override val name = "Chassis"
	override fun toString() = name

	final override val subStructures = names.map { Motor(it, enable) }

	var powers = DoubleArray(names.size) { .0 }
